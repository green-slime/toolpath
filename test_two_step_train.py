...
if __name__ == "__main__":
    ...
    version_ot =  7
    ot_foldername = cfg.output_foldername = f"output/large_{cfg.ocl_path_num}_{cfg.sample_size}_0.01_ot_{version_ot}/"
    update_output_config(cfg.sample_size, cfg.output_foldername)
    train_ot.train()

    cfg.max_epochs = 1000
    version = 9
    cfg.overlay_weights = 100.0
