...
def train():
    ...
    optimizer = torch.optim.Adam([path_points_yz], cfg.ot_learning_rate, betas=(0.8, 0.95), eps=1e-8, amsgrad=False)
    ...
    with torch.no_grad():
        ...
        torch.save(path_points_yz, f"{cfg.output_foldername}/path_points_yz_ot.pt")  # 保存路径点
